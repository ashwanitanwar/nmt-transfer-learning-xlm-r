...
#Convert BERT files to different script
python $INDIC_NLP_CLI_PARSER script_convert -s $SRC_LNG -t $TGT_LNG $INTERM_TRAIN_SOURCE.done $INTERM_TRAIN_SOURCE.done.script-converted
python $INDIC_NLP_CLI_PARSER script_convert -s $SRC_LNG -t $TGT_LNG $INTERM_VAL_SOURCE.done $INTERM_VAL_SOURCE.done.script-converted
python $INDIC_NLP_CLI_PARSER script_convert -s $SRC_LNG -t $TGT_LNG $INTERM_TEST_SOURCE.done $INTERM_TEST_SOURCE.done.script-converted

#prepare for BERT
cp $INTERM_TRAIN_SOURCE.done.script-converted $TOK_BPE_DATA_DIR/train.bpe.$LANG_PAIR.bert.$SRC_LNG 
cp $INTERM_VAL_SOURCE.done.script-converted $TOK_BPE_DATA_DIR/val.bpe.$LANG_PAIR.bert.$SRC_LNG
cp $INTERM_TEST_SOURCE.done.script-converted $TOK_BPE_DATA_DIR/test.bpe.$LANG_PAIR.bert.$SRC_LNG
