...
class SequenceGenerator(nn.Module):
    ...
    def _generate(
        ...
        ##########################attn maps
        self_attn_S2_tensor = encoder_outs[0].self_attn_at_tensor
        #bert_attn_S2_tensor = encoder_outs[0]['bert_attn_S2_tensor']
        if(self_attn_S2_tensor is not None):
            ...
            #bert_attn_S2_tensor_np = bert_attn_S2_tensor.numpy()
            ...
            print('No self attention weights obtained')
        ##########################
