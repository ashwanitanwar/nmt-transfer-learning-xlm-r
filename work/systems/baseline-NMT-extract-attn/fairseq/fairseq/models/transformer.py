...
class TransformerEncoder(FairseqEncoder):
    ...
    def forward(self, src_tokens, src_lengths, return_all_hiddens: bool = False):
        ...
        if self_attn_at_list is not None:
	            self_attn_at_tensor = torch.stack(self_attn_at_list, dim=0)  # (layers, batch, heads, tgt_len, src_len)
	            self_attn_at_tensor = self_attn_at_tensor.transpose(0, 1).contiguous()	        
