...
def load_model_ensemble(filenames, arg_overrides=None, bert_model_name=None, task=None, bert_ratio=None, encoder_ratio=None, geargs=None):
    ...
    for filename in filenames:
        ...
        setattr(args, 'bert_model_name', bert_model_name)
        if task is None:
